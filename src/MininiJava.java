/* Generated By:JavaCC: Do not edit this line. MininiJava.java */
class MininiJava implements MininiJavaConstants {
...
//Nota Joel-------------------------- Simplifique con el metodo Data()
//Nota Christian -------------------- Comente VarDeclaration
...
// Nota Christian ---------------------- Comente el metodo AssignmentStatement
/*
void AssignmentStatement():
{}
{//x=(num+2); x = ((1==num) + (2+4))
	<IDENTIFIER><ASIGNACION>Expression()<SEMICOLON>
}
*/
//Nota Joel-------------------------- Cree el metodo Expression
...
//Nota Joel-------------------------- Cambie la asignacion con expression
...
//Nota Joel-------------------------- Cree el metodo Data para simplificar algunas expresiones 
  ...
  public MininiJavaTokenManager token_source;
  ...
  public MininiJava(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public MininiJava(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new MininiJavaTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public MininiJava(java.io.Reader stream) {
  ...
  public MininiJava(MininiJavaTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(MininiJavaTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
